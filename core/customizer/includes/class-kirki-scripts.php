...
class Kirki_Scripts {
	...
	function styles() {
		...
		wp_enqueue_style( 'kirki-thememove-css', $kirki_url . 'assets/css/thememove.css', null, '0.5' );
	...
	function scripts() {
		...
		wp_enqueue_script( 'kirki_customizer_js', $kirki_url . 'assets/js/customizer.js', array(
			'jquery',
			'customize-controls'
		) );
	...
	function googlefonts() { ?>
		<link
			href='//fonts.googleapis.com/css?family=Roboto:100,400|Roboto+Slab:700,400&subset=latin,cyrillic-ext,greek,vietnamese,latin-ext,cyrillic'
	...
	function custom_css() {
		...
		<style>
			...
			<?php if ( $color_font ) : ?> color: <?php echo $color_font; ?>;
			<?php endif; ?>
			}
