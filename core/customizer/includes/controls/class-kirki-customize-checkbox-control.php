...
class Kirki_Customize_Checkbox_Control extends Kirki_Customize_Control {
	...
	public function render_content() { ?>
		...
		<label class="customizer-checkbox">
			...
			<div class="switch-info"><?php endif; ?>
				<input type="checkbox" value="<?php echo esc_attr( $this->value() ); ?>"
				       id="<?php echo $this->id . esc_attr( $this->value() ); ?>" <?php $this->link();
				checked( $this->value() ); ?><?php echo $display; ?> />
		...
		<?php if ( $this->separator ) {
			echo '<hr class="customizer-separator">';
		} ?>
		<?php
	}
}
