...
<div class="recent-posts">
	<?php while ( $loop->have_posts() ) : $loop->the_post();
		...
		<div class="recent-posts__item">
			<a href="<?php the_permalink() ?>" class="recent-posts__thumb">
			...
			<?php if ( $show_meta ): ?>
				<div class="post-meta">
					...
					<span class="post-com"><i
							class="fa fa-comments"></i> <?php comments_number( __( 'No response', 'thememove' ), __( 'One response', 'thememove' ), '%' . __( ' response', 'thememove' ) ); ?></span>
				</div>
			<?php endif ?>
		</div>
	<?php endwhile;
