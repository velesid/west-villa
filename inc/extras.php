...
function new_projects_fields( $fields ) {
	$fields['default_template'] = array(
		'name'        => esc_html__( 'Use Default Template', 'tm-builderplus' ),
		'description' => esc_html__( 'Check this option if you want to use default template for this project.', 'tm-builderplus' ),
		'type'        => 'checkbox',
		'value'       => 'yes',
		'section'     => 'info'
	);
