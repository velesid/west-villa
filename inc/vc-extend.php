...
if ( class_exists( 'WPBakeryShortCode' ) ) {
	...
	class WPBakeryShortCode_Thememove_Gmaps extends WPBakeryShortCode {
		...
		public function jsScripts() {
			wp_enqueue_script( 'thememove-js-maps', 'http://maps.google.com/maps/api/js?key=AIzaSyDzXFM-6o4X3exdxpTzv2yeRMe5JRKTo7I&amp;language=en' );
			wp_enqueue_script( 'thememove-js-gmap3', THEME_ROOT . '/js/gmap3.min.js' );
		}
	}

	class WPBakeryShortCode_Thememove_Gmaps_Multi extends WPBakeryShortCode {
		public function __construct( $settings ) {
			parent::__construct( $settings );
			$this->jsScripts();
		}
	...
	class WPBakeryShortCode_Thememove_Project_Nav extends WPBakeryShortCode {
	}

	class WPBakeryShortCode_Thememove_Project_Gallery extends WPBakeryShortCode {
	}
}
...
function custom_css_classes_for_vc_row_and_vc_column( $class_string, $tag ) {
	...
	if ( $tag == 'vc_column' || $tag == 'vc_column_inner' ) {
		$class_string = preg_replace( '/vc_col-sm-(\d{1,2})/', 'col-sm-$1 vc_col-sm-$1 col-lg-$1 vc_col-lg-$1', $class_string );
	}
...
//Recent Posts
vc_map( array(
	'name'     => __( 'TM Recent Posts', 'thememove' ),
	'base'     => 'thememove_recentposts',
	'category' => __( 'by TM Structure', 'thememove' ),
	'params'   => array(
		array(
			'type'       => 'checkbox',
...
vc_map( array(
	'name'     => __( 'TM Google Maps', 'thememove' ),
...
// Thememove Google Maps Multi Addresses
vc_map( array(
	'name'        => __( 'TM Google Maps Multi', 'thememove' ),
	'base'        => 'thememove_gmaps_multi',
	'description' => __( 'Google Map with multi addresses.', 'thememove' ),
	'category'    => __( 'by TM Structure', 'thememove' ),
	'params'      => array(
		array(
			'type'        => 'param_group',
			'heading'     => "Addresses or Coordinates",
			'admin_label' => true,
			'param_name'  => 'addresses',
			'params'      => array(
				array(
					'type'        => 'textfield',
					'heading'     => esc_html( __( 'Address', 'tm-finance' ) ),
					'param_name'  => 'address',
					'admin_label' => true
				)
			),
...
vc_map( array(
	'name'        => __( 'TM Project Details', 'thememove' ),
...
// Thememove Project Navigation
vc_map( array(
	'name'        => __( 'TM Project Navigation', 'thememove' ),
	'description' => __( 'Only available for Projects.', 'thememove' ),
	'base'        => 'thememove_project_nav',
	'category'    => __( 'by TM Structure', 'thememove' ),
	'params'      => array(
		array(
			'type'        => 'dropdown',
			'heading'     => __( 'Same category', 'thememove' ),
			'admin_label' => true,
			'param_name'  => 'same_cat',
			'value'       => array(
				'True'  => 'true',
		...
		array(
			'type'        => 'dropdown',
			'heading'     => __( 'Show project archive button', 'thememove' ),
			'admin_label' => true,
			'param_name'  => 'project_archive_button',
			'value'       => array(
				'True'  => 'true',
				'False' => 'false'
			),
...
// Thememove Project Gallery
vc_map( array(
	'name'        => __( 'TM Project Gallery', 'thememove' ),
	'description' => __( 'Only available for Projects.', 'thememove' ),
	'base'        => 'thememove_project_gallery',
	'category'    => __( 'by TM Structure', 'thememove' ),
	'params'      => array(
		array(
			'type'        => 'dropdown',
			'heading'     => __( 'Number images per slide', 'thememove' ),
			'admin_label' => true,
			'param_name'  => 'number',
			'value'       => array(
				'1' => '1',
		...
		array(
			'type'        => 'dropdown',
			'heading'     => __( 'Display pagination', 'thememove' ),
			'admin_label' => true,
