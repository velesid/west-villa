...
if ( $thememove_header_preset == 'header-preset-01' ) {
	include locate_template( 'templates/header-preset-01.php' );
} elseif ( $thememove_header_preset == 'header-preset-02' ) {
	include locate_template( 'templates/header-preset-02.php' );
} elseif ( $thememove_header_preset == 'header-preset-03' ) {
	include locate_template( 'templates/header-preset-03.php' );
} elseif ( $thememove_header_preset == 'header-preset-04' ) {
	include locate_template( 'templates/header-preset-04.php' );
} elseif ( $thememove_header_preset == 'header-preset-05' ) {
	include locate_template( 'templates/header-preset-05.php' );
} elseif ( $thememove_header_preset == 'header-preset-06' ) {
	include locate_template( 'templates/header-preset-06.php' );
} elseif ( $thememove_header_preset == 'header-preset-07' ) {
	include locate_template( 'templates/header-preset-07.php' );
} elseif ( $thememove_header_preset == 'header-preset-08' ) {
	include locate_template( 'templates/header-preset-08.php' );
} elseif ( $thememove_header_preset == '' || $thememove_header_preset == 'default' ) {
	include locate_template( 'templates/' . get_theme_mod( 'header_preset', header_preset ) . '.php' );
}
?>