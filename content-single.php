...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-bottom">
		<div class="row">
			<div class="col-sm-8">
				<?php the_tags( '<i class="fa fa-tags"></i> ' . __( 'Tags: ', 'thememove' ), ', ' ); ?>
			</div>
			<div class="col-sm-4">
				<div class="share">
					...
					<span><a target="_blank"
					         href="http://twitter.com/share?text=<?php echo urlencode( the_title() ); ?>&url=<?php echo urlencode( the_permalink() ); ?>"><i
