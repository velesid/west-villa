	...
	<?php if ( has_post_thumbnail() ) { ?>
		<div class="post-thumb">
			<div class="dates">
				...
				<span
					class="comments-counts"><span><?php comments_number( '0', '1', '%' ); ?></span><?php comments_number( 'Comment', __( 'Comment', 'thememove' ), __( 'Comments', 'thememove' ) ); ?></span>
			</div>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="share">
				...
				<span>
					<a target="_blank"
					   href="http://twitter.com/share?text=<?php echo urlencode( the_title() ); ?>&url=<?php echo urlencode( the_permalink() ); ?>">
